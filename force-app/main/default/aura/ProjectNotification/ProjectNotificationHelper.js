({
  ...
  show: function(cmp, evt) {
    ...
    openReleaseChanges:function(component)
    {
       
          var appEvent = $A.get("e.c:EventPendingProjectChanges");
    ...
    openOOCFModal:function(component)
    {
          var appOOCFEvent = $A.get("e.c:EventPendingOOCF");
           appOOCFEvent.setParams({
               "projectId" : component.get("v.recId")
          });
